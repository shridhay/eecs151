...
module counter
  ...
  wire [3:0]\NLW_cycles0_inferred__0/i__carry__0_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycles0_inferred__0/i__carry__1_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycles0_inferred__0/i__carry__2_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycles0_inferred__0/i__carry__3_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycles0_inferred__0/i__carry__4_CO_UNCONNECTED ;
  ...
  CARRY4 \cycles0_inferred__0/i__carry__0 
       (.CI(\cycles0_inferred__0/i__carry_n_0 ),
        .CO({\cycles0_inferred__0/i__carry__0_n_0 ,\NLW_cycles0_inferred__0/i__carry__0_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \cycles0_inferred__0/i__carry__1 
       (.CI(\cycles0_inferred__0/i__carry__0_n_0 ),
        .CO({\cycles0_inferred__0/i__carry__1_n_0 ,\NLW_cycles0_inferred__0/i__carry__1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \cycles0_inferred__0/i__carry__2 
       (.CI(\cycles0_inferred__0/i__carry__1_n_0 ),
        .CO({\cycles0_inferred__0/i__carry__2_n_0 ,\NLW_cycles0_inferred__0/i__carry__2_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \cycles0_inferred__0/i__carry__3 
       (.CI(\cycles0_inferred__0/i__carry__2_n_0 ),
        .CO({\cycles0_inferred__0/i__carry__3_n_0 ,\NLW_cycles0_inferred__0/i__carry__3_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \cycles0_inferred__0/i__carry__4 
       (.CI(\cycles0_inferred__0/i__carry__3_n_0 ),
        .CO({\cycles0_inferred__0/i__carry__4_n_0 ,\NLW_cycles0_inferred__0/i__carry__4_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
...
module dac
  ...
  CARRY4 pwm0_carry__0
       (.CI(pwm0_carry_n_0),
        .CO({pwm0_carry__0_n_2,NLW_pwm0_carry__0_CO_UNCONNECTED[0]}),
        .CYINIT(\<const0> ),
  ...
  LUT6 #(
    ...
    \saturating_counter[0][7]_i_2 
       (.I0(\saturating_counter_reg[0]_0 [5]),
        .I1(\saturating_counter_reg[0]_0 [4]),
        .I2(\saturating_counter_reg[0]_0 [3]),
        .I3(\wrapping_counter[15]_i_1_n_0 ),
...
(* B_PULSE_CNT_MAX = "200" *) (* B_SAMPLE_CNT_MAX = "62500" *) (* ECO_CHECKSUM = "e74f2b3a" *) 
