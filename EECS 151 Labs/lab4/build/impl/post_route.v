...
module dac
  ...
  wire pwm0_carry_n_0;
  wire [3:0]\NLW_cycles_reg[4]_i_2_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycles_reg[8]_i_2_CO_UNCONNECTED ;
  wire [3:0]NLW_pwm0_carry_CO_UNCONNECTED;
  wire [3:0]NLW_pwm0_carry__0_CO_UNCONNECTED;
  ...
  CARRY4 \cycles_reg[4]_i_2 
       (.CI(\<const0> ),
        .CO({\cycles_reg[4]_i_2_n_0 ,\NLW_cycles_reg[4]_i_2_CO_UNCONNECTED [2:0]}),
        .CYINIT(cycles[0]),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(cycles0__0[4:1]),
        .S(cycles[4:1]));
  ...
  CARRY4 \cycles_reg[8]_i_2 
       (.CI(\cycles_reg[4]_i_2_n_0 ),
        .CO({\cycles_reg[8]_i_2_n_0 ,\NLW_cycles_reg[8]_i_2_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(cycles0__0[8:5]),
        .S({Q[0],cycles[7:5]}));
  ...
  CARRY4 pwm0_carry__0
       (.CI(pwm0_carry_n_0),
        .CO({CO,NLW_pwm0_carry__0_CO_UNCONNECTED[0]}),
        .CYINIT(\<const0> ),
...
module fsm
  ...
  wire [3:0]NLW_fcw0_carry_CO_UNCONNECTED;
  wire [3:0]NLW_fcw0_carry__0_CO_UNCONNECTED;
  wire [3:0]NLW_fcw0_carry__1_CO_UNCONNECTED;
  wire [3:0]NLW_fcw0_carry__2_CO_UNCONNECTED;
  wire [3:0]NLW_fcw0_carry__3_CO_UNCONNECTED;
  wire [3:0]\NLW_phase_accumulator_reg[0]_i_1_CO_UNCONNECTED ;
  wire [3:0]\NLW_phase_accumulator_reg[12]_i_1_CO_UNCONNECTED ;
  wire [3:0]\NLW_phase_accumulator_reg[16]_i_1_CO_UNCONNECTED ;
  wire [3:0]\NLW_phase_accumulator_reg[4]_i_1_CO_UNCONNECTED ;
  wire [3:0]\NLW_phase_accumulator_reg[8]_i_1_CO_UNCONNECTED ;
  ...
  CARRY4 fcw0_carry
       (.CI(\<const0> ),
        .CO({fcw0_carry_n_0,NLW_fcw0_carry_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 fcw0_carry__0
       (.CI(fcw0_carry_n_0),
        .CO({fcw0_carry__0_n_0,NLW_fcw0_carry__0_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
        .DI(\d_out_reg[14] [6:3]),
        .O(fcw__0[9:6]),
        .S(\fcw_reg[6]_i_1 ));
  ...
  CARRY4 fcw0_carry__1
       (.CI(fcw0_carry__0_n_0),
        .CO({fcw0_carry__1_n_0,NLW_fcw0_carry__1_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 fcw0_carry__2
       (.CI(fcw0_carry__1_n_0),
        .CO({fcw0_carry__2_n_0,NLW_fcw0_carry__2_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 fcw0_carry__3
       (.CI(fcw0_carry__2_n_0),
        .CO({fcw0_carry__3_n_0,NLW_fcw0_carry__3_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
        .DI(d_out[20:17]),
        .O(fcw__0[21:18]),
  ...
  CARRY4 \phase_accumulator_reg[0]_i_1 
       (.CI(\<const0> ),
        .CO({\phase_accumulator_reg[0]_i_1_n_0 ,\NLW_phase_accumulator_reg[0]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 \phase_accumulator_reg[12]_i_1 
       (.CI(\phase_accumulator_reg[8]_i_1_n_0 ),
        .CO({\phase_accumulator_reg[12]_i_1_n_0 ,\NLW_phase_accumulator_reg[12]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 \phase_accumulator_reg[16]_i_1 
       (.CI(\phase_accumulator_reg[12]_i_1_n_0 ),
        .CO({\phase_accumulator_reg[16]_i_1_n_0 ,\NLW_phase_accumulator_reg[16]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 \phase_accumulator_reg[4]_i_1 
       (.CI(\phase_accumulator_reg[0]_i_1_n_0 ),
        .CO({\phase_accumulator_reg[4]_i_1_n_0 ,\NLW_phase_accumulator_reg[4]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 \phase_accumulator_reg[8]_i_1 
       (.CI(\phase_accumulator_reg[4]_i_1_n_0 ),
        .CO({\phase_accumulator_reg[8]_i_1_n_0 ,\NLW_phase_accumulator_reg[8]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
...
module nco
  ...
  wire [7:0]sel__0;
  wire [3:0]NLW_phase_accumulator0_carry_CO_UNCONNECTED;
  wire [3:0]NLW_phase_accumulator0_carry__0_CO_UNCONNECTED;
  wire [3:0]NLW_phase_accumulator0_carry__1_CO_UNCONNECTED;
  wire [3:0]NLW_phase_accumulator0_carry__2_CO_UNCONNECTED;
  wire [3:0]NLW_phase_accumulator0_carry__3_CO_UNCONNECTED;
  ...
  CARRY4 phase_accumulator0_carry
       (.CI(\<const0> ),
        .CO({phase_accumulator0_carry_n_0,NLW_phase_accumulator0_carry_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 phase_accumulator0_carry__0
       (.CI(phase_accumulator0_carry_n_0),
        .CO({phase_accumulator0_carry__0_n_0,NLW_phase_accumulator0_carry__0_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 phase_accumulator0_carry__1
       (.CI(phase_accumulator0_carry__0_n_0),
        .CO({phase_accumulator0_carry__1_n_0,NLW_phase_accumulator0_carry__1_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 phase_accumulator0_carry__2
       (.CI(phase_accumulator0_carry__1_n_0),
        .CO({phase_accumulator0_carry__2_n_0,NLW_phase_accumulator0_carry__2_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 phase_accumulator0_carry__3
       (.CI(phase_accumulator0_carry__2_n_0),
        .CO({phase_accumulator0_carry__3_n_0,NLW_phase_accumulator0_carry__3_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
...
module sq_wave_gen
  ...
  wire [3:0]NLW_cycles1_carry_CO_UNCONNECTED;
  wire [3:0]NLW_cycles1_carry__0_CO_UNCONNECTED;
  wire [3:0]\NLW_samples_reg[11]_i_2_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[11]_i_3_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[15]_i_2_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[15]_i_3_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[19]_i_2_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[19]_i_3_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[3]_i_2_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[3]_i_2_O_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[3]_i_3_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[7]_i_2_CO_UNCONNECTED ;
  wire [3:0]\NLW_samples_reg[7]_i_3_CO_UNCONNECTED ;
  ...
  CARRY4 cycles1_carry
       (.CI(\<const0> ),
        .CO({cycles1_carry_n_0,NLW_cycles1_carry_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 cycles1_carry__0
       (.CI(cycles1_carry_n_0),
        .CO({CO,NLW_cycles1_carry__0_CO_UNCONNECTED[1:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \samples_reg[11]_i_2 
       (.CI(\samples_reg[7]_i_2_n_0 ),
        .CO({\samples_reg[11]_i_2_n_0 ,\NLW_samples_reg[11]_i_2_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(samples00_in[11:8]),
        .S(samples[11:8]));
  ...
  CARRY4 \samples_reg[11]_i_3 
       (.CI(\samples_reg[7]_i_3_n_0 ),
        .CO({\samples_reg[11]_i_3_n_0 ,\NLW_samples_reg[11]_i_3_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI(samples[11:8]),
        .O(samples0[11:8]),
  ...
  CARRY4 \samples_reg[15]_i_2 
       (.CI(\samples_reg[11]_i_2_n_0 ),
        .CO({\samples_reg[15]_i_2_n_0 ,\NLW_samples_reg[15]_i_2_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \samples_reg[15]_i_3 
       (.CI(\samples_reg[11]_i_3_n_0 ),
        .CO({\samples_reg[15]_i_3_n_0 ,\NLW_samples_reg[15]_i_3_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI(samples[15:12]),
        .O(samples0[15:12]),
  ...
  CARRY4 \samples_reg[19]_i_2 
       (.CI(\samples_reg[15]_i_2_n_0 ),
        .CO({\samples_reg[19]_i_2_n_0 ,\NLW_samples_reg[19]_i_2_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \samples_reg[19]_i_3 
       (.CI(\samples_reg[15]_i_3_n_0 ),
        .CO({\samples_reg[19]_i_3_n_0 ,\NLW_samples_reg[19]_i_3_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI(samples[19:16]),
        .O(samples0[19:16]),
  ...
  CARRY4 \samples_reg[3]_i_2 
       (.CI(\<const0> ),
        .CO({\samples_reg[3]_i_2_n_0 ,\NLW_samples_reg[3]_i_2_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 \samples_reg[3]_i_3 
       (.CI(\<const0> ),
        .CO({\samples_reg[3]_i_3_n_0 ,\NLW_samples_reg[3]_i_3_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 \samples_reg[7]_i_2 
       (.CI(\samples_reg[3]_i_2_n_0 ),
        .CO({\samples_reg[7]_i_2_n_0 ,\NLW_samples_reg[7]_i_2_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(samples00_in[7:4]),
        .S(samples[7:4]));
  ...
  CARRY4 \samples_reg[7]_i_3 
       (.CI(\samples_reg[3]_i_3_n_0 ),
        .CO({\samples_reg[7]_i_3_n_0 ,\NLW_samples_reg[7]_i_3_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI(samples[7:4]),
        .O(samples0[7:4]),
...
(* B_PULSE_CNT_MAX = "200" *) (* B_SAMPLE_CNT_MAX = "62500" *) (* ECO_CHECKSUM = "91db801b" *) 
