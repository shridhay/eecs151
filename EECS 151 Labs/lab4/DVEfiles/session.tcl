...
# DVE full session
# Saved on Tue Oct 17 15:52:16 2023
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{299 65} {1802 1053}}
...
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1504
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 164
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1503} {height 163} {dock_state bottom} {dock_on_new_line true}}
...
catch { gui_list_select -id ${Data.1} {dac_tb.DUT.clk dac_tb.DUT.rst dac_tb.DUT.code dac_tb.DUT.next_sample dac_tb.DUT.pwm dac_tb.DUT.cycles }}
